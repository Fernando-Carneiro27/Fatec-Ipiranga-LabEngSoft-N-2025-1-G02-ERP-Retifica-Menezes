...
const AdicionarProduto = () => {
  ...
  const [produtoData, setProdutoData] = useState<Produto>({
    nome: '', descricao: '', valor: 0, data_modificacao_compra: ''
  });

  const [estoqueData, setEstoqueData] = useState({
    produto_id: 0, quantidade_min: 0, quantidade_max: 0, quantidade_atual: 0, valor_produto_venda: 0
  });
  ...
  const handleEnviar = async () => {
    ...
    const produtoComData = {
      ...produtoData,
      data_modificacao_compra: dataHoje || new Date().toISOString().split('T')[0]
    };
    console.log(produtoComData);
    const camposObrigatorios = [
      'nome', 'valor', 'data_modificacao_compra'
    ];
  ...
  return (
    <HelmetProvider>
      <Helmet> <title>Adicionar Produto</title> </Helmet>
                ...
                <TextField
                  ...
                  onChange={(e) => {
                    ...
                    if (
                      ...
                      if (!isNaN(valorNum)) {
                        setProdutoData({ ...produtoData, valor: valorNum });
                      } else {
                        setProdutoData({ ...produtoData, valor: 0 });
                      }
                    }
                  }}
                  InputProps={{
