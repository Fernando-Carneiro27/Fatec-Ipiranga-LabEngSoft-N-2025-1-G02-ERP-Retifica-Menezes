...
const ListarProdutos = () => {
  ...
  const [colunasVisiveis, setColunasVisiveis] = useState({
    id: true, nome: true, descricao: true, valor: true
  });
  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      ...
      setInfoMessage('Produto deletado com sucesso!');
    ...
    <HelmetProvider>
      ...
      <Box>
        <Box sx={stylesLista.headerProduto}>
          ...
          />
          <Box sx={stylesLista.headerProdutoSpan}>Produtos</Box>
        </Box>
                  ...
                  {(produtosFiltrados.length > 0 ? produtosFiltrados : produtos).length === 0 ? (
                    ...
                    (produtosFiltrados.length > 0
                      ...
                      <TableRow key={produto.id}>
                        ...
                        {colunasVisiveis.valor && (
                          <TableCell sx={stylesLista.linhas}>
                            <Typography gutterBottom>{formatarValor(produto.valor)}</Typography>
                          </TableCell>
                        )}
                        {colunasVisiveis.descricao && (
                          <TableCell sx={stylesLista.linhas}>
                        ...
                        <TableCell sx={{ borderBottom: '1px solid #959494', width: '20%' }} align="center">
                          ...
                          {/* <Tooltip title="Movimentações do produto" arrow>
                            <IconButton sx={{ color: '#424242' }} size="small" onClick={() => handleMovimentacao(produto.estoque?.id)}>
                              <CompareArrowsTwoTone />
                            </IconButton>
                          </Tooltip> */}
      ...
      <Snackbar
        ...
        autoHideDuration={
          infoMessage === 'Nenhum produto encontrado.' ? 3000 : 4000
        }
