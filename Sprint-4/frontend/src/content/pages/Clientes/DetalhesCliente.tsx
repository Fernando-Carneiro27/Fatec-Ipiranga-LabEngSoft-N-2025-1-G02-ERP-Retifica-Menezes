...
import { Box, Table, TableBody, TableCell, TableContainer, TableRow, Button, Tabs, Tab, CircularProgress, Typography } from '@mui/material';
...
const DetalhesCliente = () => {
  ...
  return (
    <HelmetProvider>
      <Helmet> <title>Detalhes do Cliente</title> </Helmet>
      <Navbar />
      <Box sx={{ height: '70vh' }}>
