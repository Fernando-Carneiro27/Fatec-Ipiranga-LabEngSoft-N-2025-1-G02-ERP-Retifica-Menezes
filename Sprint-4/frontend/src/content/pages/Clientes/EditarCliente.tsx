...
import { TextField, Button, Box, Snackbar, Typography, IconButton, CircularProgress } from '@mui/material';
...
const EditarCliente = () => {
  ...
  const handleEnviar = async (e: React.FormEvent) => {
    ...
    const camposObrigatorios: (keyof ClienteUpdate)[] = [
      'nome', 'cpf_cnpj', 'email', 'telefone', 'cep', 'endereco', 'bairro', 'tipo', 'status_cliente'
    ];
  ...
  return (
    <HelmetProvider>
      <Helmet> <title>Editar Cliente</title> </Helmet>
      <Box sx={{ paddingTop: '103px' }}>
        ...
        <Box sx={stylesEditar.contPrincipal}>
          <Box sx={stylesEditar.grayContainer}>
            <Box sx={stylesEditar.photoContainer}>
