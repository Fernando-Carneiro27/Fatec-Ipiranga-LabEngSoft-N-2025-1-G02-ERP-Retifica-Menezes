                ...
                <TableHead>
                  <TableRow sx={{ backgroundColor: '#DCDDDE', width: '100%', alignItems: 'center' }}>
                    ...
                    {colunasVisiveis.valor_compra && (
                      <TableCell sx={stylesLista.colunas}>VALOR DE COMPRA</TableCell>
                    )}
                    {colunasVisiveis.valor_venda && (
                      <TableCell sx={stylesLista.colunas}>VALOR DE VENDA</TableCell>
                    )}
                    {colunasVisiveis.quantidade_atual && (
                      <TableCell sx={stylesLista.colunas}>QUANTIDADE ATUAL</TableCell>
                    )}
                    ...
                    (produtosFiltrados.length > 0
                      ...
                      <TableRow key={produto.id}>
                        ...
                        {colunasVisiveis.valor_venda && (
                          <TableCell sx={stylesLista.linhas}>
                            <Typography gutterBottom>
                              {produto.estoque?.valor_produto_venda !== undefined
                                ? formatarValor(produto.estoque.valor_produto_venda)
                                : 'Carregando...'}
                            </Typography>
                          </TableCell>
                        )}
                        ...
                        <TableCell
                          ...
                          align="center"
                        >
                          <Tooltip title="Editar estoque" arrow>
                            <IconButton
                              color="primary"
                              size="small"
