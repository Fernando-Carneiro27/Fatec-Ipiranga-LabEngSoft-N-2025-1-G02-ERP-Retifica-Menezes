  ...
  return (
    <HelmetProvider>
      ...
      <Box sx={stylesHistorico.headerHistorico}>
        ...
        />
        <Typography sx={stylesHistorico.headerHistoricoSpan}> Serviço - Histórico de Valores de Venda </Typography>
      </Box>

      <Box sx={stylesHistorico.servicosDetalhes}>
        <Box sx={stylesHistorico.abas}>
          <Typography  sx={stylesHistorico.aba}> {servicoData?.nome} </Typography>
        </Box>
