...
const DetalhesProduto = () => {
  ...
  const [produtoData, setProdutoData] = useState<{ id: Number; nome: string; descricao: string; valor: number; }>({
      ...
      <Box sx={stylesProduto.produtosDetalhes}>
        ...
        <Table size="small" aria-label="detalhes do produto">
            ...
            <TableRow>
                ...
                <TableCell sx={stylesProduto.campoValor}> {produtoData.valor} </TableCell>
            </TableRow>
            <TableRow>
